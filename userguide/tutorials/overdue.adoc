...
* The system was started with the system property  `org.killbill.server.test.mode=true` which allows to move the clock through time (if you used the Docker installation method, this is enabled by default).
